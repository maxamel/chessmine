    ...
    def test_time_run_out(self):
        ...
        with socketio.SimpleClient() as sio:
            ...
            def game_over(data):
                ...
                self.assertEqual(data.get('message'), 'white ran out of time')
                ...
                self.assertEqual(self.redis_cli.hget(f'game_endgame_{game_id}', 'message'), 'white ran out of time')
            ...
            f = open('resources/partial_game.json', 'r')
            lines = tuple(f)
            ...
            time.sleep(62)      # wait for time to run out
